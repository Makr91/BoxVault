...
import { FaStar, FaBook, FaRocket, FaHeart, FaGithub, FaCode, FaServer } from 'react-icons/fa6';
  ...
  return (
    <div className="container">
      <div className="text-center mb-5">
        <h1 className="display-4 fw-bold">{projectData.title || t('about.fallbackTitle')}</h1>
        <p className="lead text-muted">
          {projectData.description || t('about.fallbackDescription')}
        </p>
        <span className="badge bg-primary fs-5">v{BoxVaultVersion.version}</span>
        ...
        {currentUser?.provider?.startsWith('oidc-') && (
          <div className="mt-3">
            ...
            {favoriteMessage && <div className="alert alert-info mt-2">{favoriteMessage}</div>}
          </div>
        )}
      </div>
        ...
        <div className="col-md-6">
          <div className="card h-100 shadow-sm">
            ...
            <div className="card-body">
              <p className="card-text">{t('about.documentation.description')}</p>
          ...
          <div className="col-12">
            <div className="card shadow-sm">
              <div className="card-body text-center">
                <p className="mb-0 lead">{projectData.goal || t('about.fallbackGoal')}</p>
              </div>
            </div>
          </div>
        </div>
