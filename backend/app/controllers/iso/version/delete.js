 ...
 *     description: Delete the version and its file records. A physical file is removed only when no other ISO file record shares its storage path (deduplication within the organization).
 *     tags: [ISOs]
 *     security:
 *       - JwtAuth: []
 *     parameters:
