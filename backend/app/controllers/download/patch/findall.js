 ...
 *     description: Retrieve the patches of a release within the caller's reach, each with the files within it. The product must be visible to the caller; a release beyond the caller's reach answers 404.
 *     tags: [Downloads]
 *     parameters:
 *       - in: path
 *         name: organization
