...
The body also carries `organizations`, `preferred_language`, `preferred_theme`, `preferred_pack`, `preferred_motion`, `email_hash`, `avatar_url` and `entitlements`. There is no refresh token.
